...
public class NeuronalNetworkTestPatterns : NeuronalNetworkForwardPropagation
{
    ...
    /// The mutexes.
    /// </summary>
    private readonly List<Mutex> mutexes = new();
    ...
    public void PatternsTestingThread(int patternNumber)
    {
        ...
        {
            throw new ArgumentNullException(nameof(this.database), "The database isn't initialized properly.");
        }
        ...
        while (this.nextPattern < patternNumber)
        {
            ...
            if (this.eventStop is not null && this.eventStop.WaitOne(0, true))
            {
